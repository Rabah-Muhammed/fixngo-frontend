...
const WorkerChatPage = () => {
  ...
  const { worker, accessToken } = useSelector((state) => state.worker);
  ...
  useEffect(() => {
    ...
    if (activeChatId) {
      ...
      console.log("Worker Email from Redux:", workerEmail);
      ...
      ws.onclose = (e) => {
        ...
        console.log("error", `Chat closed: ${e.code}`);
      };
      ws.onerror = (error) => {
  ...
  }, [activeChatId, navigate, accessToken, workerEmail]);
    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-3.5 flex items-center justify-between sticky top-0 z-10 shadow-lg">
          ...
          <span className="text-sm opacity-80">Worker Chat</span>
        </div>
