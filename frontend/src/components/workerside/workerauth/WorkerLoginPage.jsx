...
const WorkerLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Change token names to worker-specific tokens
      localStorage.setItem("workerAccessToken", response.data.access);
      localStorage.setItem("workerRefreshToken", response.data.refresh);
